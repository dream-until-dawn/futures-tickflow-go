...
func refMA(cs []tickflow.Bar, n int) []float64 {
...
func refEMA(cs []tickflow.Bar, n int, conv Convention) []float64 {
...
func refMACD(cs []tickflow.Bar, fast, slow, signal int, conv Convention) (dif, dea, hist []float64) {
...
func refRSI(cs []tickflow.Bar, n int, conv Convention) []float64 {
...
func refCCI(cs []tickflow.Bar, n int) []float64 {
...
func refBOLL(cs []tickflow.Bar, n int, k float64) (mid, up, dn []float64) {
...
func refKDJ(cs []tickflow.Bar, n, m1, m2 int, conv Convention) (kv, dv, jv []float64) {
...
func cmpCol(t *testing.T, label string, ind Indicator, cs []tickflow.Bar, k int, want []float64) {
	t.Helper()
	rows := Compute(ind, cs)
	for i := range cs {
		got := rows[i][k]
