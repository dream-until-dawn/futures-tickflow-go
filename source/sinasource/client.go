...
//
// ⛔ **登记⑯：这个值与登记⑨（丙格）相乘，才是真正的风险，而它【现在还没上膛】。**
//
//	Since = 2018-05-01（产品类下界）
//	RB2610 首日 2025-10-16 ⇒ 中间 **2725 天**（TA2701 2820 / T2612 2876）
//	那一整段每一天都是：**日历说是交易日、而新浪没有这一行** = 丙格 ⇒ **静默**
//
// ⚠️ **而今天它被另一个东西挡着**（实测）：
//
...
// 而那一刻所有人的注意力都在「日历终于覆盖到 2018 了」这件好事上。
// ⇒ 处置在 Syncer 那一层（⑨ 的按日遍历）；**做 v0.4 之前必须先有它。**
//
